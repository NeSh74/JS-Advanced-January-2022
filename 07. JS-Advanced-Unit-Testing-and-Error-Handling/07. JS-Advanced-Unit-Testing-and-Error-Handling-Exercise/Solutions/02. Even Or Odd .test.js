...
describe('isOddOrEven function tests', () => {
    //invalid input test
    it('should return undifined if the parameter is number', () => {
        assert.equal(isOddOrEven(10), undefined);
    });
    it('should return undifined if the parameter is object', () => {
        assert.equal(isOddOrEven({}), undefined);
    });
    it('should return undifined if the parameter is array', () => {
        assert.equal(isOddOrEven([]), undefined);
    });
    it('should return undifined if the parameter is undifined', () => {
        assert.equal(isOddOrEven(undefined), undefined);
    });
    it('should return undifined if the parameter is null', () => {
